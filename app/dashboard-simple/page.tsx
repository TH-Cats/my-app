// Simple dashboard without database dependencies for testing production deployment
export default function SimpleDashboardPage() {
  return (
    <main className="max-w-6xl mx-auto p-8">
      <div className="mb-6">
        <h1 className="text-3xl font-bold">Dashboard (Simple Version)</h1>
        <p className="text-sm text-gray-600 mt-1">
          データベース接続なしの本番テスト用ダッシュボード
        </p>
      </div>
      ...
      <div className="bg-white border rounded-lg p-6">
        <h2 className="text-xl font-semibold mb-4">心拍ゾーン別分析（モックデータ）</h2>
        ...
        <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded">
          <p className="text-sm text-yellow-800">
            <strong>注意:</strong> これは本番デプロイテスト用のシンプルバージョンです。
            実際のダッシュボードは <code>/dashboard</code> でアクセスできます。
          </p>
        </div>
      </div>
    </main>
