    ...
    <main className="min-h-screen space-y-6">
      ...
      <section className="bg-white border rounded p-4">
        ...
        <div className="mt-3 flex gap-2">
          ...
          <button disabled={loading || !plan || !msg} onClick={adjust} className="px-3 py-2 rounded bg-green-600 text-white disabled:opacity-50">調整を反映</button>
          <button disabled={loading} onClick={generate} className="px-3 py-2 rounded bg-blue-600 text-white disabled:opacity-50">{loading? '生成中…':'新規生成'}</button>
